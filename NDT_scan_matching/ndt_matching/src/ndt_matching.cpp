...
static ros::Publisher ndt_signal_pub;
  ...
  if (map_loaded == 1 && init_pos_set == 1)
  {
    ...
    */
    ...
    else
    {
      ...
      localizer_pose_msg.pose.covariance[3] = cov(0,3);
      localizer_pose_msg.pose.covariance[4] = cov(0,4);
      localizer_pose_msg.pose.covariance[5] = cov(0,5);
      ...
      localizer_pose_msg.pose.covariance[9] = cov(1,3);
      localizer_pose_msg.pose.covariance[10] = cov(1,4);
      localizer_pose_msg.pose.covariance[11] = cov(1,5);
      ...
      localizer_pose_msg.pose.covariance[15] = cov(2,3);
      localizer_pose_msg.pose.covariance[16] = cov(2,4);
      localizer_pose_msg.pose.covariance[17] = cov(2,5);
      localizer_pose_msg.pose.covariance[18] = cov(3,0);
      localizer_pose_msg.pose.covariance[19] = cov(3,1);
      localizer_pose_msg.pose.covariance[20] = cov(3,2);
      localizer_pose_msg.pose.covariance[21] = cov(3,3);
      localizer_pose_msg.pose.covariance[22] = cov(3,4);
      localizer_pose_msg.pose.covariance[23] = cov(3,5);
      localizer_pose_msg.pose.covariance[24] = cov(4,0);
      localizer_pose_msg.pose.covariance[25] = cov(4,1);
      localizer_pose_msg.pose.covariance[26] = cov(4,2);
      localizer_pose_msg.pose.covariance[27] = cov(4,3);
      localizer_pose_msg.pose.covariance[28] = cov(4,4);
      localizer_pose_msg.pose.covariance[29] = cov(4,5);
      localizer_pose_msg.pose.covariance[30] = cov(5,0);
      localizer_pose_msg.pose.covariance[31] = cov(5,1);
      localizer_pose_msg.pose.covariance[32] = cov(5,2);
      localizer_pose_msg.pose.covariance[33] = cov(5,3);
      localizer_pose_msg.pose.covariance[34] = cov(5,4);
      localizer_pose_msg.pose.covariance[35] = cov(5,5);
    ...
    estimate_twist_msg.header.frame_id = "chassis_link";
    ...
    // std::cout << fitness_score * hessian << std::endl;
    // std::cout << "-----------------------------------------------------------------" << std::endl;
...
int main(int argc, char** argv)
{
  ...
  localizer_pose_pub = nh.advertise<geometry_msgs::PoseWithCovarianceStamped>("/localizer_pose", 10);
  ...
  ndt_signal_pub = nh.advertise<std_msgs::Empty>("/signal", 1);
