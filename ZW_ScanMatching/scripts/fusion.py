...
class Fusion:
    ...
    def fusion(self):
        ...
        try:
            ...
            self.pose_fusion.pose.position.z = self.stat_fusion[2,0]
            q = quaternion_from_euler(self.stat_fusion[3,0],self.stat_fusion[4,0],self.stat_fusion[5,0])
...
def main():
    ...
    rospy.Subscriber("/top_ndt_pose", Odometry, fusion.callback_mid)
