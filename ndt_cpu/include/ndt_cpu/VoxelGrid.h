...
public:
  ...
  float optimize(Eigen::Matrix3d &c_a, Eigen::Matrix3d &c_b);

  void initial_cov(Eigen::Matrix3d &inv_c, Eigen::Vector3d &Mean);
  void fuse(Eigen::Matrix3d &inv_c, Eigen::Vector3d &Mean);
...
private:
  ...
  // void fuse(Eigen::Matrix3d &c_a, Eigen::Matrix3d &c_b, Eigen::Vector3d &mean_a, Eigen::Vector3d &mean_b);
